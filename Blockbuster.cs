...
namespace BlockbusterLab
{
    public class Blockbuster
    {
        ...
        List<Movie> Movies = new List<Movie>
        {
            ...
            new VHS("Speed", Genre.Action, 90, new List<string>(){"Keanu gets on the bus", "The bus goes either too fast or too slow", "Keanu gets off the bus"}, 0)
        };
        ...
        {
            PrintMovies();
            Console.WriteLine($"Which movie would you like? Pick a number between 0 and {Movies.Count - 1}");
